...
### O que é Git?
 ...
 Git é um sistema de controle de versão que auxilia hoje a maioria das empresas que utilizam de desenvolvimento de software. Com ele é possivel entender todo o histórico de desenvolvimento dos projetos nele inseridos, analisar como foram feitos e se necessário voltar a eles a qualquer momento.
 
 ![](/blog/2021-03-12-guia-rapido-de-git-e-github_files/git.png)
 
### O que é o GitHub?

 O Github é um serviço online, hoje distribuido pela Microsoft que hospeda repositórios Git, através dele temos um local onde armazenar todos os nossos projetos e consequentemente, os commits e ramos advindos deste projeto.
...
Esse processo faz com que você tenha um repositório remoto, hospedado no GitHub no seu computador, sendo também a maneira mais fácil de criar um repositório remoto que será hospedado no GitHub e gerenciado na sua máquina local.
...
- Volta para a master;
- Deleta a branch;
- Upa a branch com as alterações criadas no repositório remoto(Se foi seguido os passos anteriores GitHub).
