---
title: Tutorial para Análise COVID-19
author: Altamiro, Davi e Marcelo
date: '2020-08-05'
slug: tutorial-para-análise-covid-19
categories:
  - covid19
tags:
  - covid
...
![](/blog/2020-08-05-tutorial-para-análise-covid-19_files/corona.jpg){width=80% height=60%}
...
# Análise gráfica
  ...
  Nessa etapa mostraremos dois gráficos de acumulação para os casos de confirmação e mortes da doença no Estado do **Paraná**.
...
#selecionamos dentro da variável dados.cidades apenas os dados que contém o tipo de local igual a state
...
![](/blog/2020-08-05-tutorial-para-análise-covid-19_files/consciencia.jpg){width=60% height=70%}
